...
@php
    ...
    $isSuperAdmin = in_array($user->aid, config('light.superAdmin'));
@endphp
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            @php // dump($light_menu['children']->groupBy('group'));  @endphp
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="{{ route('admin::userManage.edit', ['id' => \Auth::guard('admin')->user()->aid]) }}">编辑用户</a></dd>
                </dl>
            </li>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    @foreach($menu as $sub)
                        @if((int)$sub['status'] === App\Model\Admin\Menu::STATUS_ENABLE && ($isSuperAdmin || $user->can($sub['name'])))

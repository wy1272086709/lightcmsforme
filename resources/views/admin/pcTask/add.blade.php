...
@section('js')
    <script type="text/javascript">
        ...
        function getLocationHref(index) {
            ...
            switch (index) {
                case 0:
                    href = "{{route('admin::pcTask.add', [ 'taskType' => \App\Utils\ConstantUtils::ADS_SERVICE ])}}";
                    break;
                case 1:
                    href = "{{route('admin::pcTask.add', [ 'taskType' => \App\Utils\ConstantUtils::SEARCH_SERVICE ])}}";
                    break;
                case 2:
                    href = "{{route('admin::pcTask.add', [ 'taskType' => \App\Utils\ConstantUtils::FLOW_SERVICE ])}}";
                    break;
                case 3:
                    href = "{{route('admin::pcTask.add', [ 'taskType' => \App\Utils\ConstantUtils::HAO_123_SERVICE ])}}";
                    break;
            }
            return href;
        }

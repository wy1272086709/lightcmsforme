...
Route::group(
    ...
    function () {
        ...
        Route::get('/test3', 'TestController@index3')->name('test.index3');
        Route::get('/test5', 'TestController@index5')->name('test.index5');

        Route::get('/test6', 'TestController@index6')->name('test.index6');
        ...
        Route::middleware('log:admin', 'auth:admin', 'authorization:admin')->group(function () {
            ...
            Route::post('/upload', 'UploadController@run')->name('upload.run');

            Route::get('/config', 'AreaXmlController@index')->name('areaXml.index');
            Route::get('/config/list', 'AreaXmlController@list')->name('areaXml.list');
